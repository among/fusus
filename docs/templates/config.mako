<%!
    ...
    git_link_template = 'https://github.com/annotation/text-fabric/blob/{commit}/{path}#L{start_line}-L{end_line}'
    ...
    google_search_query = 'inurl:github.com/annotation  site:annotation.github.io  site:www.annotation.nl'
    #search_query = ''
