...
# - the input image is always grayscale
# - if the input image is empty, we return none
# - we skip the logging
...
def nlbin(
    ...
    Returns:
        np.array containing the binarized image
    ...
    # Interpolation and percentile filtering
